...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class', 
        title=str('Total Success Launch for site ' + entered_site))
        return fig
...
def get_scatter_plot(entered_site, entered_range):
    filtered_df = spacex_df
    #print(filtered_df[(filtered_df['Payload Mass (kg)'] >= entered_range[0])])
    ...
    #print("ENTERED RANGE: " + str(entered_range))
    if entered_site == 'ALL':
